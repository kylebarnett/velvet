...
export const metadata: Metadata = { title: "Company Dashboard | PostSig" };
      ...
      {!isApproved && (
        <div className="rounded-md border border-[var(--status-warning-bg)] bg-[var(--status-warning-bg)] px-3 py-2 text-sm text-[var(--status-warning-text)]">
          {relationship.approval_status === "denied"
            ...
            : !company.founder_id
              ? <>This company&apos;s founder hasn&apos;t joined PostSig yet. You can manage their invitation from your <Link href="/contacts" className="underline underline-offset-2 hover:text-[var(--status-warning-text)]">contacts page</Link>.</>
